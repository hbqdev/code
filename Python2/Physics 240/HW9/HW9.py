# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 20:07:38 2013
...
for i in range(steps*2) :
    coords = rk4(r1[-1],t1[-1],delta_t1,l_derivs,params)
    r1 = vstack((r1, coords))
    t1 = vstack((t1,t1[-1]+delta_t1)) 
    coords = rk4(r2[-1],t2[-1],delta_t2,l_derivs,params)
    r2 = vstack((r2, coords))
