...
public class Asteroid implements Drawable
{
    ...
    public Asteroid(double xPos, double yPos, double anAngle, int aSize, int frameWidth, int frameHeight)
    {
        ...
        if (aSize == 1)
        {
          ...
          catch (IOException ex)
          {
            ...
            boundary = new Rectangle2D.Double(x+5, y+5, image.getWidth(null)-5, image.getHeight(null)-5);
            points = SMALL_POINTS;
        }
    ...
    public void move()
    {
        ...
        Rectangle2D.Double temp = new Rectangle2D.Double(x+5, y+5, boundary.getWidth(), boundary.getHeight());
    ...
    private static final int SMALL_SPEED = 3; //Small Asteroid speed
    private static final int MEDIUM_SPEED = 2; //Medium Asteroid speed
    private static final int LARGE_SPEED = 1; //Large Asteroid speed
    ...
    private static final double FAST_ANGLE = 1; //Angle speed for small asteroid
    private static final double MEDIUM_ANGLE = 0.5; //Angle speed for medium asteroid
    private static final double SLOW_ANGLE = 0.25; //Angle speed for large asteroid
