...
public class Bullet implements Drawable
{
    ...
    public static void incrementBulletDelayTime()
    {
        timeSinceLastBullet++;
    }
    
    /**
     * Retrieves the time since the last bullet was fired.
     * @return timeSincLastBullet The time since the last bullet was fired in program cycles.
     */
    public static int getTimeSinceLastBullet()
    {
     ...
     */
     ...
     {   
         ...
         // Sets the identity to the center of the ship
         identity.translate(middleX - image.getWidth(null) / 2, y);
         trans.setTransform(identity);
         
         bound.setTransform(identity);
         // Sets the boundary point to the center of the ship
...
*/         
    ...
    private final static double BULLET_SIZE = 1.25;
    private static int timeSinceLastBullet = 100; //An Arbitrary high number to make sure a Bullet can always be fired for the first time
    private Image image;
