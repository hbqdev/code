...
public class GameEngine
{
    public static void main(String[] args)
    {
        ...
        while(playAgain)
        {
            ...
            //sets up the very first screen before loading.
...
//        frame.dispose(); // Just closes frame window doesn't kill app
    ...
    public static final double SHIP_ACCELERATION = .05;
    public static final double MAX_SPEED = 4.5;
    public static final int MOVEMENT_INTERVAL = 10; // In milliseconds.
    public static final int KEY_INTERVAL = 10; // in milliseconds\
